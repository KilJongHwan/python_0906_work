# 람다란 ? 간단한 함수의 선언과 호출을 하나의 식으로 간략히 표현한 방식
# 파이썬에서 람다함수를 통해 이름이 없는 함수를 만들 수 있다.
# 람다 함수의 장점은 코드의 간결함, 메모리의 절약이라고 생각할 수 있다.
# def add(a, b):
#     return a + b
# print(add(1, 2))
#
...
# in_ = [1,2,3,4,5]
#
# out_ = list(map(lambda n : n * n, in_)) # 함수 자리에 람다식으로 만들어 대입하는 방법
# print(out_)
